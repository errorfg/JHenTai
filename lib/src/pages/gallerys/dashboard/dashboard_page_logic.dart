...
class DashboardPageLogic extends BasePageLogic {
  ...
  Future<void> loadRanklist() async {
    ...
    state.ranklistGallerys = await super
        .postHandleNewGallerys(gallerysAndPageInfo[0], cleanDuplicate: false);
  ...
  Future<void> loadPopular() async {
    ...
    state.popularGallerys = await super
        .postHandleNewGallerys(gallerysPage.gallerys, cleanDuplicate: false);
