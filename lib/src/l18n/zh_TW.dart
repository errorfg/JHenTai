...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'portraitImageRegionWidthRatio': '直屏圖片區域寬度比例',
      'landscapeImageRegionWidthRatio': '橫屏圖片區域寬度比例',
      ...
      'portraitDisplayFirstPageAlone': '直屏單獨顯示首頁',
      'landscapeDisplayFirstPageAlone': '橫屏單獨顯示首頁',
      'toggleFullScreen': '切換全螢幕',
      'keyboardShortcuts': '鍵盤快捷鍵',
      'keyboardShortcutsHint': '自訂閱讀頁鍵盤快捷鍵',
      'pressAnyKey': '按下任意鍵...',
      'unboundKey': '未綁定',
      'clearKey': '清除',
      'resetAll': '重置全部',
      'resetSuccess': '已重置為預設',
      'keyConflict': '鍵位衝突',
      'fixedKeyHint': '固定鍵位，不可自訂',
      'pressAnyKeyOrMouseSideButton': '按下任意鍵或滑鼠側鍵...',
      'mouseButton4Name': '滑鼠前進鍵',
      'mouseButton5Name': '滑鼠後退鍵',
      'toLeft': '向左翻頁',
      'toRight': '向右翻頁',
