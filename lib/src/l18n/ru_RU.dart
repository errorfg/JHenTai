...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'showRotationFABHint':
          'Показать плавающую кнопку для переключения между портретным и альбомным режимами',
      ...
      'keyboardShortcutsHint': 'Настроить горячие клавиши страницы чтения',
      'pressAnyKey': 'Нажмите любую клавишу...',
      'unboundKey': 'Не назначено',
      'clearKey': 'Очистить',
      ...
      'mixedModeUnavailable':
          'Смешанный режим недоступен: текущий макет не предоставляет время добавления в избранное',
...
Пример 2: Блокировать комментарии с оценкой не выше 10 -> Комментарий Оценка <= 10
    ''',
      ...
      'readerSourcePdf': 'PDF',
      'readerSource': 'Источник чтения',
      'switchReaderSource': 'Сменить источник чтения',
      'komgaSetting': 'Сервер Komga',
      'komgaSettings': 'Настройки Komga',
      'komgaServerUrl': 'URL сервера',
      'komgaApiKey': 'Ключ API',
      'komgaApiKeyHint': 'Ключ API имеет приоритет над именем и паролем',
      'or': 'или',
      'retry': 'Повторить',
      'saveSetting': 'Сохранить',
      'books': 'книг',
      'invalidKomgaServerUrl': 'Введите корректный HTTP- или HTTPS-адрес',
      'komgaCredentialsRequired': 'Введите ключ API или имя пользователя',
      'komgaConnectionSuccess': 'Подключение к Komga установлено',
      'komgaNotConfigured': 'Настройте сервер Komga для просмотра библиотеки',
      'configureKomga': 'Настроить Komga',
      'komgaNoLibraries': 'Библиотеки Komga не найдены',
      'komgaNoSeries': 'Серии не найдены',
      'komgaNoBooks': 'Книги не найдены',
      'komgaBookNotReady': 'Эта книга ещё не готова к чтению',
      ...
      'komgaUnread': 'Не прочитано',
      'komgaInProgress': 'В процессе',
      'komgaRead': 'Прочитано',
      'komgaNewlyAdded': 'Недавно добавленные',
      'komgaSortAdded': 'Дата добавления',
      'komgaSortLastRead': 'Последнее чтение',
      'komgaSortTitle': 'Название',
      'komgaAscending': 'По возрастанию',
      'komgaDescending': 'По убыванию',
      'komgaCardView': 'Карточки',
      'komgaListView': 'Список',
      'komgaDetailView': 'Подробно',
      'komgaAddedAt': 'Добавлено: @date',
      'komgaLastReadAt': 'Последнее чтение: @date',
      'komgaUnreadPages': 'Не прочитано · @total стр.',
      'komgaContinueAt': 'Продолжить · @current/@total',
      'komgaCompletedPages': 'Прочитано · @total стр.',
      'komgaSeriesProgress':
          'Прочитано: @completed · в процессе: @ongoing · не прочитано: @remaining',
      'komgaNewSinceLastVisit': 'Новое с последнего посещения',
      'komgaNoMatchingItems': 'Нет элементов, соответствующих текущим фильтрам',
      'komgaBrowseOptions': 'Параметры просмотра',
      'pdfLibrary': 'Библиотека PDF',
      'pdfLibraryEmpty': 'PDF не найдены в дополнительных путях сканирования.',
      'pdfHasNoPages': 'В этом PDF нет доступных страниц',
