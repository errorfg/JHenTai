...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'keyboardShortcutsHint': '읽기 페이지 키보드 단축키 사용자 정의',
      ...
      'keyConflict': '키 충돌',
      'fixedKeyHint': '고정 키, 사용자 정의 불가',
      'pressAnyKeyOrMouseSideButton': '임의 키 또는 마우스 측면 버튼을 누르세요...',
      'mouseButton4Name': '마우스 앞으로 (버튼 4)',
      'mouseButton5Name': '마우스 뒤로 (버튼 5)',
      'toLeft': '왼쪽으로 이동',
      'toRight': '오른쪽으로 이동',
      ...
      'wnacgFavorite': 'wnacg 즐겨찾기',
      'mixWnFavorites': 'wnacg 즐겨찾기 혼합 표시',
      'wnacgDomain': 'wnacg 도메인',
