...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'cloudSync': '云同步',
      'syncProvider': '同步方式',
      'syncProviderHint': '选择同步配置的云存储方式',
      'cloudProviderS3': 'S3 兼容存储',
      'cloudProviderWebDAV': 'WebDAV',
      's3Sync': 'S3 同步 (R2/S3/MinIO)',
      's3Config': 'S3 配置',
      'enableS3': '启用 S3 同步',
      'enableS3Hint': '使用 S3 兼容存储同步配置（支持 Cloudflare R2, AWS S3, MinIO 等）',
      's3Endpoint': 'Endpoint',
      's3EndpointHint': '例如: <account-id>.r2.cloudflarestorage.com',
      's3AccessKey': 'Access Key',
      's3SecretKey': 'Secret Key',
      's3BucketName': 'Bucket 名称',
      's3Region': 'Region',
      's3RegionHint': 'Cloudflare R2 使用 auto',
      's3BaseKey': '对象键前缀',
      's3BaseKeyHint': '例如: jhentai-sync/',
      's3UseSSL': '使用 SSL',
      'webdavConfig': 'WebDAV 配置',
      'enableWebDAV': '启用 WebDAV 同步',
      'enableWebDAVHint': '使用 WebDAV 协议同步配置',
      'webdavServerUrl': '服务器地址',
      'webdavServerUrlHint': '例如: https://dav.jianguoyun.com/dav/',
      'webdavUsername': '用户名',
      'webdavPassword': '密码',
      'webdavRemotePath': '远程路径',
      'webdavRemotePathHint': '例如: /JHenTaiConfig',
      'historySettings': '历史版本设置',
      'historyVersion': '历史版本',
      'enableHistory': '启用历史版本',
      'enableHistoryHint': '每次同步时保存带时间戳的历史版本',
      'maxHistoryVersions': '最大版本数',
      'maxHistoryVersionsHint': '保留最近的 N 个版本，超出时自动删除',
      'autoCleanHistory': '自动清理',
      'autoCleanHistoryHint': '自动删除超出数量的旧版本',
      'viewHistory': '查看历史',
      ...
      'restore': '恢复',
      'delete': '删除',
      'restoreFromHistory': '从历史版本恢复',
      'restoreWarning': '这将用选定的历史版本替换您的当前配置。此操作无法撤销。',
      'syncToCloudAfterRestore': '恢复后同步到云端',
      'syncToCloudAfterRestoreHint': '使恢复的版本成为最新版本',
      'restoreSuccess': '恢复成功',
      'restoreFailed': '恢复失败',
      'deleteVersion': '删除版本',
      ...
      'clearAllHistoryConfirm': '确定要清空所有历史版本吗？',
      'clearAllHistorySuccess': '清空成功',
      'clearAllHistoryFailed': '清空失败',
      ...
      'connectionFailed': '连接失败',
      'syncNow': '立即同步',
      'selectSyncTypes': '选择同步类型',
      'syncSuccess': '同步成功',
      'syncStatistics': '同步统计',
      'localCount': '本地数量',
      'remoteCount': '远程数量',
      'mergedCount': '合并后数量',
      'addedFromRemote': '从远程添加',
      'conflicts': '冲突数',
      'syncComplete': '同步完成',
      'size': '大小',
      'loadHistoryFailed': '加载历史失败',
      'restoreVersion': '恢复版本',
      'restoreVersionConfirm': '确定要恢复此版本吗？',
      'restoreVersionWarning': '这将用选定的历史版本替换您的当前配置。此操作无法撤销。',
      'totalVersions': '总版本数',
      'clearAllHistoryWarning': '此操作将删除所有历史版本，无法撤销。',
      'clearAll': '全部清空',
      'clearSuccess': '清空成功',
      'clearFailed': '清空失败',
      'deleteSuccess': '删除成功',
      ...
      'portraitImageRegionWidthRatio': '竖屏图片区域宽度比例',
      'landscapeImageRegionWidthRatio': '横屏图片区域宽度比例',
      ...
      'portraitDisplayFirstPageAlone': '竖屏单独展示首页',
      'landscapeDisplayFirstPageAlone': '横屏单独展示首页',
      'toggleFullScreen': '切换全屏',
      'keyboardShortcuts': '键盘快捷键',
      'keyboardShortcutsHint': '自定义阅读页键盘快捷键',
      'pressAnyKey': '按下任意键...',
      'unboundKey': '未绑定',
      'clearKey': '清除',
      'resetAll': '重置全部',
      ...
      'pressAnyKeyOrMouseSideButton': '按下任意键或鼠标侧键...',
      'mouseButton4Name': '鼠标前进键',
      'mouseButton5Name': '鼠标后退键',
      'toLeft': '向左翻页',
      'toRight': '向右翻页',
...
favnote：匹配收藏备注
      ...
      'cloudSyncSettings': 'WebDAV/S3 同步设置',
      'cloudSyncSettingsHint': '配置 WebDAV 或 S3 兼容存储进行自动同步',
      'upload2cloud': '上传至云',
    ...
    ''',
      ...
      'readerSourcePdf': 'PDF',
      'readerSource': '阅读来源',
      'switchReaderSource': '切换阅读来源',
      'komgaSetting': 'Komga 服务器',
      'komgaSettings': 'Komga 设置',
      'komgaServerUrl': '服务器地址',
      'komgaApiKey': 'API 密钥',
      'komgaApiKeyHint': 'API 密钥优先于用户名和密码',
      'or': '或',
      'retry': '重试',
      'saveSetting': '保存',
      'books': '本书',
      'invalidKomgaServerUrl': '请输入有效的 HTTP 或 HTTPS 服务器地址',
      'komgaCredentialsRequired': '请输入 API 密钥或用户名',
      'komgaConnectionSuccess': '已连接到 Komga',
      'komgaNotConfigured': '配置 Komga 服务器后即可浏览其中的漫画',
      'configureKomga': '配置 Komga',
      'komgaNoLibraries': 'Komga 中没有可用的媒体库',
      'komgaNoSeries': '没有找到系列',
      'komgaNoBooks': '没有找到漫画',
      'komgaBookNotReady': '这本漫画尚未准备好阅读',
      'komgaBookHasNoPages': '这本 Komga 漫画没有可阅读的页面',
      'komgaConfigSyncHint': '开启自动云同步后，服务器与认证信息会同步到你的其他设备。',
      'komgaProgressSyncHint': '阅读进度以 JHenTai 为准，只单向上报给 Komga。',
      'komgaImportProgress': '导入 Komga 阅读进度',
      'komgaImportProgressEmpty': 'Komga 中没有可导入的阅读进度',
      'komgaImportProgressImported': '已导入 @count 条 Komga 阅读进度',
      'komgaImportProgressUpToDate': 'JHenTai 阅读进度已是最新',
      'komgaSeriesView': '系列',
      'komgaAllBooksView': '全部书籍',
      'komgaAllStatuses': '全部状态',
      'komgaUnread': '未读',
      'komgaInProgress': '阅读中',
      'komgaRead': '已读',
      'komgaNewlyAdded': '新添加',
      'komgaSortAdded': '添加时间',
      'komgaSortLastRead': '最近阅读',
      'komgaSortTitle': '标题',
      'komgaAscending': '升序',
      'komgaDescending': '降序',
      'komgaCardView': '卡片',
      'komgaListView': '列表',
      'komgaDetailView': '详细信息',
      'komgaAddedAt': '添加于 @date',
      'komgaLastReadAt': '最近阅读于 @date',
      'komgaUnreadPages': '未读 · 共 @total 页',
      'komgaContinueAt': '继续阅读 · @current/@total',
      'komgaCompletedPages': '已读完 · 共 @total 页',
      'komgaSeriesProgress':
          '已读 @completed · 阅读中 @ongoing · 未读 @remaining',
      'komgaNewSinceLastVisit': '上次访问后新增',
      'komgaNoMatchingItems': '没有符合当前筛选条件的内容',
      'komgaBrowseOptions': '浏览选项',
      'pdfLibrary': 'PDF 书库',
      'pdfLibraryEmpty': '在额外画廊扫描路径中没有找到 PDF。',
      'pdfHasNoPages': '这个 PDF 没有可阅读的页面',
