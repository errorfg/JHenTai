...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'showRotationFABHint':
          'Show a floating button to toggle between portrait and landscape',
      ...
      'enableSyncHint': 'Enable or disable cloud sync feature',
      'autoSync': 'Auto Sync on Startup',
      'autoSyncHint': 'Automatically sync configuration on app startup',
      'manualSync': 'Manual Sync',
      'manualSyncHint':
          'Automatically determine upload or download based on timestamps',
      ...
      'syncProviderHint': 'Choose cloud storage method for syncing config',
      'cloudProviderS3': 'S3-Compatible Storage',
      'cloudProviderWebDAV': 'WebDAV',
      's3Sync': 'S3 Sync (R2/S3/MinIO)',
      's3Config': 'S3 Configuration',
      'enableS3': 'Enable S3 Sync',
      'enableS3Hint':
          'Sync config using S3-compatible storage (supports Cloudflare R2, AWS S3, MinIO, etc.)',
      's3Endpoint': 'Endpoint',
      's3EndpointHint': 'e.g.: <account-id>.r2.cloudflarestorage.com',
      's3AccessKey': 'Access Key',
      's3SecretKey': 'Secret Key',
      's3BucketName': 'Bucket Name',
      's3Region': 'Region',
      's3RegionHint': 'Use auto for Cloudflare R2',
      's3BaseKey': 'Object Key Prefix',
      's3BaseKeyHint': 'e.g.: jhentai-sync/',
      's3UseSSL': 'Use SSL',
      'webdavConfig': 'WebDAV Configuration',
      'enableWebDAV': 'Enable WebDAV Sync',
      'enableWebDAVHint': 'Sync config using WebDAV protocol',
      'webdavServerUrl': 'Server URL',
      'webdavServerUrlHint': 'e.g.: https://dav.jianguoyun.com/dav/',
      'webdavUsername': 'Username',
      'webdavPassword': 'Password',
      'webdavRemotePath': 'Remote Path',
      'webdavRemotePathHint': 'e.g.: /JHenTaiConfig',
      'historySettings': 'History Version Settings',
      'historyVersion': 'History Version',
      'enableHistory': 'Enable History',
      'enableHistoryHint': 'Save timestamped history versions on each sync',
      'maxHistoryVersions': 'Max Versions',
      'maxHistoryVersionsHint':
          'Keep the most recent N versions, auto-delete when exceeded',
      'autoCleanHistory': 'Auto Cleanup',
      'autoCleanHistoryHint':
          'Automatically delete old versions exceeding the count',
      ...
      'restoreWarning':
          'This will replace your current configuration with the selected history version. This action cannot be undone.',
      'syncToCloudAfterRestore': 'Sync to cloud after restore',
      'syncToCloudAfterRestoreHint':
          'Make the restored version the new latest version',
      ...
      'clearAllHistoryConfirm':
          'Are you sure you want to clear all history versions?',
      'clearAllHistorySuccess': 'Clear successful',
      'clearAllHistoryFailed': 'Clear failed',
      ...
      'clearAllHistoryWarning':
          'This will delete all history versions and cannot be undone.',
      'clearAll': 'Clear All',
      ...
      'cloudSyncSettings': 'WebDAV/S3 Sync Settings',
      'cloudSyncSettingsHint':
          'Configure WebDAV or S3-compatible storage for automatic sync',
      ...
      'mixedModeUnavailable':
          'Mixed mode unavailable: current layout does not provide favorited time',
...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'readerSourcePdf': 'PDF',
      'readerSource': 'Reading source',
      'switchReaderSource': 'Switch reading source',
      'komgaSetting': 'Komga server',
      'komgaSettings': 'Komga settings',
      'komgaServerUrl': 'Server URL',
      'komgaApiKey': 'API key',
      'komgaApiKeyHint': 'API key takes priority over username and password',
      'or': 'or',
      'retry': 'Retry',
      'saveSetting': 'Save',
      'books': 'books',
      'invalidKomgaServerUrl': 'Enter a valid HTTP or HTTPS server URL',
      'komgaCredentialsRequired': 'Enter an API key or username',
      'komgaConnectionSuccess': 'Connected to Komga',
      'komgaNotConfigured': 'Configure a Komga server to browse its library',
      'configureKomga': 'Configure Komga',
      'komgaNoLibraries': 'No Komga libraries found',
      'komgaNoSeries': 'No series found',
      'komgaNoBooks': 'No books found',
      'komgaBookNotReady': 'This book is not ready for reading',
      ...
      'komgaUnread': 'Unread',
      'komgaInProgress': 'In progress',
      'komgaRead': 'Read',
      'komgaNewlyAdded': 'Newly added',
      'komgaSortAdded': 'Date added',
      'komgaSortLastRead': 'Last read',
      'komgaSortTitle': 'Title',
      'komgaAscending': 'Ascending',
      'komgaDescending': 'Descending',
      'komgaCardView': 'Cards',
      'komgaListView': 'List',
      'komgaDetailView': 'Details',
      'komgaAddedAt': 'Added @date',
      'komgaLastReadAt': 'Last read @date',
      'komgaUnreadPages': 'Unread · @total pages',
      'komgaContinueAt': 'Continue · @current/@total',
      'komgaCompletedPages': 'Completed · @total pages',
      'komgaSeriesProgress':
          '@completed read · @ongoing in progress · @remaining unread',
      'komgaNewSinceLastVisit': 'New since last visit',
      'komgaNoMatchingItems': 'No items match the current filters',
      'komgaBrowseOptions': 'Browse options',
