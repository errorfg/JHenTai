...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'enableS3Hint': 'Sync config using S3-compatible storage (supports Cloudflare R2, AWS S3, MinIO, etc.)',
      's3Endpoint': 'Endpoint',
      ...
      'maxHistoryVersionsHint': 'Keep the most recent N versions, auto-delete when exceeded',
      'autoCleanHistory': 'Auto Cleanup',
      'autoCleanHistoryHint': 'Automatically delete old versions exceeding the count',
      ...
      'restoreWarning': 'This will replace your current configuration with the selected history version. This action cannot be undone.',
      'syncToCloudAfterRestore': 'Sync to cloud after restore',
      'syncToCloudAfterRestoreHint': 'Make the restored version the new latest version',
      ...
      'clearAllHistoryConfirm': 'Are you sure you want to clear all history versions?',
      ...
      'restoreVersionWarning': 'This will replace your current configuration with the selected history version. This action cannot be undone.',
      'totalVersions': 'Total Versions',
      'clearAllHistoryWarning': 'This will delete all history versions and cannot be undone.',
      'clearAll': 'Clear All',
      ...
      'mouseButton4Name': 'Mouse Forward (Button 4)',
      'mouseButton5Name': 'Mouse Back (Button 5)',
      'toLeft': 'Turn Left',
      'toRight': 'Turn Right',
      ...
      'cloudSyncSettingsHint': 'Configure WebDAV or S3-compatible storage for automatic sync',
